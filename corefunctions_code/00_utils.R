...
# --- Sample a new DP atom from the base distribution ---
# Decoupled base distribution H:
#   (δ1, δ2) ~ Uniform({-1,+1}^2)
#   shape_beta  ~ Gamma(a_shape_beta, b_shape_beta)   [curvature strength]
#   shape_gamma ~ Gamma(a_shape_gamma, b_shape_gamma)  [linearity/slack, sparsity-inducing]
...
# --- Stick-breaking weights to conditional persistence probabilities ---
# pi_weights: vector of stick-breaking weights (from Beta(1, varsigma))
# Returns pi_star: conditional persistence probabilities
